    ...
    function validateCurrentStep() {
        ...
        if (currentStep === 5) {
            ...
            if (termsCheckbox && !termsCheckbox.checked) {
                ...
                showMessage('You must agree to the Terms and Conditions to proceed', 'danger');
                isValid = false;
...
// CRITICAL: Enhanced logout with browser cache clearing
        ...
        .then(data => {
            if (data.success) {
                ...
                setTimeout(() => {
                    ...
                    const redirectUrl = data.data.redirect || '/affiliate-login';
